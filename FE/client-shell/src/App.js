...
const ClientRestaurants = React.lazy(() => import('client_restaurants_ui/App'));
const ClientReservations = React.lazy(() => import('client_reservations_ui/App'));
...
const App = ({ isLightTheme, setToken, userToken }) => {
  const theme = themes.client[isLightTheme ? 'light' : 'dark'];
            ...
            <Routes path="/">
              ...
              <Route
                ...
                element={
                  <AuthHoc userToken={userToken}>
                    <React.Suspense fallback="Loading...">
                      <ClientRestaurants path="/" userToken={userToken} />
                    </React.Suspense>
                  </AuthHoc>
                }
              ></Route>
              ...
              <Route
                ...
                element={
                  <AuthHoc userToken={userToken}>
                    <React.Suspense fallback="Loading...">
                      <ClientReservations path="/reservations" userToken={userToken} />
                    </React.Suspense>
                  </AuthHoc>
                }
              ></Route>
